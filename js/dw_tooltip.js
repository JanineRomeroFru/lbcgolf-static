...
var dw_Tooltip = {
    ...
    positionRelEvent: function(e, tgt) {
        var _this = dw_Tooltip; var coords;
    ...
    calcPosCoords: function(e, tgt) {
        ...
        ty = y + this.offY;
        alty = y - ( this.height + this.offY );
        spA =  y - dw_Viewport.scrollY > dw_Viewport.height/2;
...
//        document.body.insertAdjacentHTML("beforeEnd", '<iframe id="tipShim" src="#" style="position:absolute; left:0; top:0; z-index:500; visibility:hidden; background:transparent;" scrolling="no" frameborder="0"></iframe>');
